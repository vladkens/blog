...
The most noticeable shift here was Rust, so it makes sense to start with it before the rest.
...
_Data aggregated from this site (with [umami](https://umami.is/)), Medium, and Dev.to. [Script](https://github.com/vladkens/blog/blob/a627318/_stats_at_glance.py)._
