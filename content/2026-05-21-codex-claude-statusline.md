...
Still, the idea is worth taking. The command gets called on each update, receives JSON on `stdin`, and you can parse and format it however you want. Docs for available fields: https://code.claude.com/docs/en/statusline#available-data
